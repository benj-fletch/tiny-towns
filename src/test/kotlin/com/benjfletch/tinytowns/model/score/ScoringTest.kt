...
abstract class ScoringTest {
    @ParameterizedTest
    @MethodSource("scores")
    fun `Accurately calculates score`(scoringPiece: ScoringPiece, inputLocation: Location, gameGrid: GameGrid, expected: Int) {
        val score = scoringPiece.score(inputLocation, gameGrid)
        assertThat(score)

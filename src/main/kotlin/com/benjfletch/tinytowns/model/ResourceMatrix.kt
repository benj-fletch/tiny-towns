...
typealias ResourceMatrix = Array<Array<Resource>>
...
fun transpose(elements: ResourceMatrix): ResourceMatrix {
    ...
    val transposed = ResourceMatrix(cols) { Array(rows) {Resource.NONE} }
...
fun ResourceMatrix.rotate90() = transpose(this).map { it.reversedArray() }.toTypedArray()
